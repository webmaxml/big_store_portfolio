...
define('tabs',['jquery', 'underscore', 'backbone'], function( $, _, Backbone ) {
...
define('rating',['jquery', 'underscore', 'backbone'], function( $, _, Backbone ) {
...
define('productView',['jquery', 'underscore' , 'backbone', 'ui/effect', 'effect/effect-fade'], function( $, _, Backbone ) {
...
define('shoppingCart',['jquery', 'ui/unique-id', 'ui/effect', 'effect/effect-clip'], function( $ ) {
	$(function() {
...
define('trending',['jquery', 'isotope', 'jquery-bridget/jquery.bridget'], function( $, Isotope ) {
...
define('topSlider',['jquery', 'owlCarousel'], function( $ ) {
	$(function() {
...
define('featuredSlider',['jquery', 'owlCarousel'], function( $ ) {
	$(function() {
...
define('brandSlider',['jquery', 'owlCarousel'], function( $ ) {
	$(function() {
 ...
 *  jquery.ui.mouse.js
 */
define('jqueryUITouch',['jquery', 'ui/widget', 'widget/mouse'], function ($) {
...
define('productsScrollbar',['jquery', 'jqueryUITouch', 'widget/slider'], function( $ ) {
	$(function() {
...
define('saleBadge',['jquery'], function( $ ) {
	$(function() {
...
;(function(factory) {
	if (typeof define === 'function' && define.amd) {
		// AMD
		define('formStyler',['jquery'], factory);
...
( function( factory ) {
	if ( typeof define === "function" && define.amd ) {
		...
		// AMD. Register as an anonymous module.
		define( 'ui/form',[ "jquery", "ui/version" ], factory );
	} else {
...
define('techForm',['jquery', 'formStyler', 'widget/spinner'], function( $ ) {
	$(function() {

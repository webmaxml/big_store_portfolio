...
define('productView/mediator',['jquery', 'underscore' , 'backbone'], function( $, _, Backbone ) {
	var mediator = {};
	_.extend( mediator, Backbone.Events );

	return mediator;
});
define('productView/thumbs',['jquery', 'underscore' , 'backbone', './mediator'], function( $, _, Backbone, mediator ) {
...
define('productView/templates',[],function() {

	var productImg = '<a class="product__img-link" href="<%= src %>"><img class="product__img" src="<%= src %>"></a>';
...
define('productView/image',['jquery', 'underscore' , 'backbone', './mediator', './templates'], 
...
define('productView/main',['jquery', './thumbs', './image'], function( $, Thumbs, Image ) {
...
define('productView', ['productView/main'], function (main) { return main; });

define('currency/templates',[],function() {
...
define('currency/currency',['jquery', 'underscore', 'backbone', './templates'], function( $, _, Backbone, templates ) {
...
define('currency/main',['jquery', './currency'], function( $, Currency ) {
...
define('currency', ['currency/main'], function (main) { return main; });

define('topSlider/mediator',['jquery', 'underscore' , 'backbone'], function( $, _, Backbone ) {
	var mediator = {};
	_.extend( mediator, Backbone.Events );
...
define('topSlider/entities/container',['jquery', 'underscore', 'backbone', './../mediator', 'owlCarousel'], 
...
define('text!topSlider/templates/sliderItem.html',[],function () { return '<div class="top-slider__img-box">\r\n\t<img src="<%= imgSrc %>" alt="<%= imgAlt %>" class="top-slider__img">\r\n</div>\r\n<div class="top-slider__info-box">\r\n\t<h1 class="top-slider__header"><%= header %></h1>\r\n\t<p class="top-slider__text"><%= text %></p>\r\n\t<a href="product.html" class="top-slider__btn">\r\n\t\t<span class="top-slider__btn-text">Shop now</span>\r\n\t\t<i class="fa fa-arrow-right top-slider__btn-arrow"></i>\r\n\t</a>\r\n</div>\r\n';});

define('topSlider/entities/slides',['jquery', 'underscore', 'backbone', 'text!./../templates/sliderItem.html', './../mediator', 'owlCarousel'], 
...
define('topSlider/entities/buttons',['jquery', 'underscore', 'backbone', './../mediator', 'owlCarousel'], 
function( $, _, Backbone, mediator ) {
...
define('topSlider/main',['jquery', './entities/container','./entities/slides', './entities/buttons'], function( $, Container, Slides, Buttons) {
...
define('topSlider', ['topSlider/main'], function (main) { return main; });
...
define( 'global',['require','productView','currency','topSlider'],function( require ) {
...
define('app',[ 'jquery', 'global'], function( $, App ) {
